...
function BestSellerCard({ item }: { item: (typeof bestSellers)[number] }) {
  return (
    <article
...
function EventLink({ className }: { className: string }) {
  return (
    <a
      className={className}
      href="#contact"
...
function Arrow640Icon({ className }: SvgIconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 640 640"
...
function ChevronRightIcon({ className, strokeWidth = 2 }: SvgIconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
function LocationPinOutlineIcon({ className }: SvgIconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
function MenuBookIcon({ className }: SvgIconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
function ArrowRightIcon({ className, strokeWidth = 2 }: SvgIconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
function PartyIcon({ className }: SvgIconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 64 64"
